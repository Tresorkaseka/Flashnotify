...
Application web Flask démontrant l'utilisation de concepts POO avancés en Python : **Décorateurs de classes**, **Descripteurs** et **Métaclasses**.
...
Les dépendances sont déjà installées. Le projet est prêt à l'emploi dans l'environnement Replit.
