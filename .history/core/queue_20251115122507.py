...
from queue import Queue # Importation de la classe Queue synchrone
...
class AsyncQueue:
    ...
    def send_notification_sync(self, user_id: int, title: str, body: str, emergency_type: str = "académique") -> str:
