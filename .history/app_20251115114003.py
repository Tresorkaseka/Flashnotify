...
def send_notification_sync(user_id, title, body, emergency_type_value):
    """Fonction synchrone pour envoyer une notification via la file d'attente asynchrone"""
    try:
        # Création d'une nouvelle boucle d'événements pour cette tâche
        ...
        logging.error(f"Erreur dans send_notification_sync: {e}")
        raise
